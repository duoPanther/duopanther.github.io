...
function initWidget(waifuPath, apiPath) {
	if (screen.width <= 768 || (localStorage.getItem("waifu-display") && new Date().getTime() - localStorage.getItem("waifu-display") <= 60*8)) return;
	localStorage.removeItem("waifu-display");
	sessionStorage.removeItem("waifu-text");
	$("body").append(`<div id="waifu">
			<div id="waifu-tips"></div>
			<canvas id="live2d" width="200" height="280"></canvas>
			<div id="waifu-tool">
				<span class="fa fa-lg fa-comment"></span>
				<!--
				<span class="fa fa-lg fa-paper-plane"></span>
				-->
				<span class="fa fa-lg fa-envira"></span>
